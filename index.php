                ...
                <div id="myCarousel" class="carousel slide" data-ride="carousel"> 
                    ...
                    <div class="carousel-inner"> 
                        ...
                        <div class="carousel-item">
                            <img src="images/slider2.jpeg" alt="slider2">
                        </div>
                        <div class="carousel-item">
                            <img src="images/slider3.jpeg" alt="slider3">
                        </div>
                    </div>
                    <!-- Carousel Inner End -->
    ...
    <div id="content" class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-4 col-sm-6  col-lg-4  single">
                ...
                <div class="product">
                <a href="details.php">
                       <img class="img-fluid" src="admin_area/product_images/products1.jpeg" alt="Product 1">
                   </a>
                    <!-- text Begin -->
                   <div class="text">
